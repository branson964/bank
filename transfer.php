           ...
           $row2 = $array3->fetch_assoc();
            echo "<div class='alert alert-success w-50 mx-auto'>
                  <form method='POST'>
                    ...
                    Account Holder Bank Name.
                    <input type='text' class='form-control' value='Bank Name' readonly required>
                    Enter Amount for tranfer.
                    <input type='number' name='amount' class='form-control' min='1' max='$userData[balance]' required>
    ...
    if (isset($_POST['transfer']))
    {
      ...
      if ($array ->num_rows > 0) 
      {
         while ($row = $array->fetch_assoc()) 
         {
            ...
            {
              echo "<div class='alert alert-warning'>Transfer has been made for  Ksh.$row[debit] from your account at $row[date] to  account no.$row[other]</div>";
            }
